...
ethereum as (
    SELECT 
        ...
        -- Number of either WETH or USDT divided by the right number of decimals times the unit price of either WETH or USDT in USD
    ...
    INNER JOIN prices.usd p ON p.minute = date_trunc('minute', om.evt_block_time)
        ...
        -- https://etherscan.io/tx/0x0831db6af74c935724b82d72f0ccd269bf428004ff3da2b3d90c310ebe886af0
